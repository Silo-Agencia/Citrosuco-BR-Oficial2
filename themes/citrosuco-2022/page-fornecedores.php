...
<section class="fornew">

    <div class="container-fluid">
        <div class="row">

            <div class="col-12 col-md-6">
                <img class="sideimg" src="<?php echo get_template_directory_uri(); ?>/assets/img/fornecedores/banner-GeM_01.png">
            </div>

            <div class="col-12 col-md-6 align-self-center">

                <img class="txt" src="<?php echo get_template_directory_uri(); ?>/assets/img/fornecedores/banner-GeM_04.png"><br>
                <img class="txt" src="<?php echo get_template_directory_uri(); ?>/assets/img/fornecedores/banner-GeM_06.png"><br>
                <a class="btn-col-acessa" href="<?php echo home_url('gestao-e-monitoramento'); ?>">Acessar aqui</a>
            </div>
        ...
        <div class="row">
            <div class="col-12 tab-content">
                <div class="tab-pane fade" id="um" role="tabpanel">
                    ...
                    <br>
                    <p><strong>Juliana Suellen Carlos Romao</strong> – (16) 3383-8767</p>
                                ...
                                <div class="container-relatorios-hidden row justify-content-center">
                                    <div class="col-12 col-md-4">
                                        <a href="<?php echo get_template_directory_uri(); ?>/assets/misc/protecitrus_2022-12-15.pdf" target="_blank">
                                            <img src="<?php echo home_url(); ?>/wp-content/uploads/2022/12/Icones_Protecitrus.png">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <a href="<?php echo get_template_directory_uri(); ?>/assets/misc/lmr_2022-12-15.pdf" target="_blank">
                                            <img src="<?php echo home_url(); ?>/wp-content/uploads/2022/12/Icones_LMR.png">
