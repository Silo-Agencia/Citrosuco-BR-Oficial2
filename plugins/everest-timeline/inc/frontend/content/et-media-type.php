    ...
    <div class="et-image"><?php if ( has_post_thumbnail( $post -> ID ) ) { ?>
            ...
            <?php if ( isset( $et_option[ 'et_show_lightbox' ] ) && $et_option[ 'et_show_lightbox' ] == '1' ) { ?>
                <a class="et-lightbox-image" href="<?php echo $src[ 0 ]; ?>">
                    <img src="<?php echo $image_url; ?>" alt="<?php echo esc_attr($alt); ?>">
                </a>
                <?php
            } else {
                ?>
        <a href="<?php echo get_permalink( $post -> ID ); ?>" target="_blank"><img src="<?php echo $image_url; ?>" alt="<?php echo esc_attr($alt); ?>"></a>
